...
class Ride_Bike_Serializer(serializers.ModelSerializer):
    class Meta:
        model = All_Ride_Historie
        fields = ['User_Uid','Ride','Date','Ride_Time','pickup_location_lat','pickup_location_long','drop_location_lat','drop_location_long','Km','Fare','User_ratings','Driver_ratings','Cancel_Ride','status']
class Ride_Car_Serializer(serializers.ModelSerializer):
    class Meta:
        model = All_Ride_Historie
        fields = ['User_Uid','Ride','Carpooling_User_1_Uid','Carpooling_User_2_Uid','Carpooling_User_3_Uid','Date','Ride_Time','pickup_location_lat','pickup_location_long','drop_location_lat','drop_location_long','Km','Fare','User_ratings','Driver_ratings','Cancel_Ride','status']
